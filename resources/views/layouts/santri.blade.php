...
<head>
    ...
    <title>@yield('title', 'Dashboard Santri — RTQ Kawali')</title>
...
<body class="font-sans antialiased bg-gray-50 dark:bg-[#071011] text-gray-800 dark:text-gray-100 transition-colors duration-300">
    ...
    <div class="flex min-h-screen">
        <aside class="fixed inset-y-0 left-0 z-50 w-72 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-auto"
            ...
            <div class="flex flex-col h-full bg-white/80 dark:bg-[#0c1a1c]/95 backdrop-blur-2xl border-r border-gray-200/60 dark:border-teal-900/30">
                <div class="flex items-center gap-3.5 px-6 py-6 border-b border-gray-100 dark:border-teal-900/30">
                    <div class="w-11 h-11 rounded-2xl bg-gradient-to-br from-teal-500 to-cyan-600 p-0.5 shadow-lg shadow-teal-500/25">
                    ...
                    <div>
                        ...
                        <p class="text-[11px] text-teal-500 dark:text-teal-400 font-semibold">Panel Santri</p>
                    </div>
                ...
                <div class="mx-4 mt-5 mb-2">
                    <div class="bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-900/20 dark:to-cyan-900/20 rounded-2xl p-4 border border-teal-100/60 dark:border-teal-800/30">
                        <div class="flex items-center gap-3">
                            @php $santriData = Auth::user()->santri; @endphp
                            @if($santriData && $santriData->foto)
                                <img src="{{ asset('storage/' . $santriData->foto) }}" alt="Foto" class="w-10 h-10 rounded-xl object-cover shadow-md shadow-teal-500/20">
                            @else
                                <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-teal-500 to-cyan-600 flex items-center justify-center text-white font-bold text-sm shadow-md shadow-teal-500/20">
                                    {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                                </div>
                            @endif
                            <div class="min-w-0">
                                <p class="text-sm font-bold text-gray-900 dark:text-white truncate">{{ Auth::user()->name }}</p>
                                <p class="text-[11px] text-teal-500 dark:text-teal-400 font-semibold">Santri</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <nav class="flex-1 px-4 py-4 space-y-1.5 overflow-y-auto">
                    ...
                    @php
                        $navItems = [
                            ['route' => 'siakad.santri.dashboard', 'title' => 'Dashboard', 'icon' => 'M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z'],
                            ['route' => 'siakad.santri.hafalan', 'title' => 'Hafalan', 'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253'],
                            ['route' => 'siakad.santri.nilai', 'title' => 'Nilai / Rapor', 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01'],
                            ['route' => 'siakad.santri.perizinan', 'title' => 'Perizinan', 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'],
                        ];
                    @endphp
                    ...
                    @foreach($navItems as $nav)
                        <a href="{{ route($nav['route']) }}"
                            ...
                            <div class="w-8 h-8 rounded-lg flex items-center justify-center {{ request()->routeIs($nav['route']) || request()->routeIs($nav['route'] . '.*') ? 'bg-teal-100 dark:bg-teal-800/40' : 'bg-gray-100 dark:bg-gray-800' }}">
                ...
                <div class="px-4 py-4 border-t border-gray-100 dark:border-teal-900/30 space-y-1.5">
        ...
        <div class="flex-1 flex flex-col min-w-0">
            <header class="sticky top-0 z-30 bg-white/80 dark:bg-[#0c1a1c]/80 backdrop-blur-xl border-b border-gray-200/60 dark:border-teal-900/30">
                <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 hidden sm:block">@yield('page_subtitle', 'Panel Santri')</p>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <footer class="px-4 sm:px-6 lg:px-8 py-4 border-t border-gray-100 dark:border-gray-800/40">
                <p class="text-xs text-center text-gray-400 dark:text-gray-600">&copy; {{ date('Y') }} Pondok Pesantren RTQ Kawali — Santri Panel</p>
            </footer>
        </div>
    </div>
</body>
