...
<body class="font-sans antialiased bg-gray-50 dark:bg-[#070d14] text-gray-800 dark:text-gray-100 transition-colors duration-300">
    ...
    <div class="flex min-h-screen">
        <aside class="fixed inset-y-0 left-0 z-50 w-72 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-auto"
            ...
            <div class="flex flex-col h-full bg-white/80 dark:bg-[#0c1a1f]/95 backdrop-blur-2xl border-r border-gray-200/60 dark:border-teal-900/30">
                <div class="flex items-center gap-3.5 px-6 py-6 border-b border-gray-100 dark:border-teal-900/30">
                    <div class="w-11 h-11 rounded-2xl bg-linear-to-br from-teal-500 to-emerald-600 p-0.5 shadow-lg shadow-teal-500/25">
                    ...
                    <div>
                        ...
                        <p class="text-[11px] text-teal-500 dark:text-teal-400 font-semibold">Ustadz PPDB</p>
                    </div>
                ...
                <div class="mx-4 mt-5 mb-2">
                    <div class="bg-linear-to-br from-teal-50 to-emerald-50 dark:from-teal-900/20 dark:to-emerald-900/20 rounded-2xl p-4 border border-teal-100/60 dark:border-teal-800/30">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-xl bg-linear-to-br from-teal-500 to-emerald-600 flex items-center justify-center text-white font-bold text-sm shadow-md shadow-teal-500/20">
                ...
                <nav class="flex-1 px-4 py-4 space-y-1.5 overflow-y-auto">
                    ...
                    <a href="{{ route('ustadz.dashboard') }}"
                        ...
                        <div class="w-8 h-8 rounded-lg flex items-center justify-center {{ request()->routeIs('ustadz.dashboard') ? 'bg-teal-100 dark:bg-teal-800/40' : 'bg-gray-100 dark:bg-gray-800' }}">
                            <svg class="w-4.5 h-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg>
                        </div>
                        Dashboard
                    </a>

                    <a href="{{ route('ustadz.pendaftar.index') }}"
                        class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200
                        {{ request()->routeIs('ustadz.pendaftar.*')
                            ? 'bg-teal-50 dark:bg-teal-900/30 text-teal-700 dark:text-teal-300 shadow-sm'
                            : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800/60 hover:text-gray-900 dark:hover:text-white' }}">
                        <div class="w-8 h-8 rounded-lg flex items-center justify-center {{ request()->routeIs('ustadz.pendaftar.*') ? 'bg-teal-100 dark:bg-teal-800/40' : 'bg-gray-100 dark:bg-gray-800' }}">
        ...
        <div class="flex-1 flex flex-col min-w-0">
            <header class="sticky top-0 z-30 bg-white/80 dark:bg-[#0c1a1f]/80 backdrop-blur-xl border-b border-gray-200/60 dark:border-teal-900/30">
                <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 hidden sm:block">@yield('page_subtitle', 'Panel Ustadz PPDB')</p>
                        </div>
                    </div>
                </div>
            </header>
